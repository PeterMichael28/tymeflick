...
export const ReviewDetailsButton: React.FC<{ onClick?: () => void }> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="flex cursor-pointer items-center gap-2 rounded border border-[#0B54FF] bg-[#CCDBFF80] px-3 py-1.5 text-sm text-[#0B54FF] transition hover:bg-[#CCDBFF80]"
    >
      <svg
        width="17"
        height="17"
...
export const ApproveButton: React.FC<{
  ...
  return (
    <button
      onClick={onClick}
      className="flex cursor-pointer items-center gap-2 rounded border border-[#036732] bg-[#1FC16B1A] px-3 py-1.5 text-sm text-[#036732] transition hover:bg-green-50"
    >
      <svg
        width="17"
        height="17"
...
export const RejectButton: React.FC<{
  ...
  return (
    <button
      onClick={onClick}
      className="flex cursor-pointer items-center gap-2 rounded border border-[#D00416] bg-[#FB37481A] px-3 py-1.5 text-sm text-[#D00416] transition hover:bg-red-50"
    >
      <svg
        width="12"
        height="12"
