...
export default function SubmitWeeklyTimeLogs() {
  ...
  return (
    <div className="min-h-screen w-full space-y-6 overflow-y-visible bg-[#F8F9FB]">
      {/* Hero Section */}
      <Hero
      ...
      <div className="space-y-6 rounded-lg border border-gray-200 bg-white p-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="rounded-md bg-[#F6F6F6] p-4 text-center">
        ...
        <div className="flex justify-end gap-3 border-t border-gray-100 pt-4">
          <button
            className="rounded-lg bg-[#E4E7EB] px-8 py-3 font-semibold text-gray-800 transition hover:bg-[#D9DDE1]"
            onClick={() => navigate('/timeTracker')}
          >
            Cancel
          </button>
          <Button
            className="rounded-lg bg-[#70C94C] px-8 py-3 font-semibold text-white hover:bg-[#5BB63B]"
