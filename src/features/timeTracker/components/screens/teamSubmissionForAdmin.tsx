          ...
          <div className="space-y-5">
            ...
            <div className="rounded-lg border-l-4 border-blue-400 bg-white p-4">
              ...
              <div className="flex flex-wrap gap-3">
                <ReviewDetailsButton onClick={() => navigate('/reviewDetailsAdmin')} />
                <button className="flex items-center gap-1 rounded-md border border-yellow-400 px-3 py-1 text-sm text-yellow-600 bg-[#FFB6001A] hover:bg-yellow-50">
                  <Unlock className="h-4 w-4" /> Unlock
                </button>
                <ApproveButton onClick={() => navigate('/forceApprove')} isAdmin/>
                <RejectButton onClick={() => navigate('/forceReject')} isAdmin/>                
              </div>
            </div>
