...
import { ArrowLeft, LockKeyhole, CheckCircle2, XCircle, FileText, Clock3 } from "lucide-react";
import {
  ...
  return (
    <div className="p-6 space-y-8 font-inter">
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex items-start justify-between">
        ...
        <span className="text-sm text-blue-600 border border-blue-300 px-3 py-1 rounded-full h-fit">
          Submitted
        </span>
      </div>
