...
import { ReviewDetailsButton, ApproveButton, RejectButton } from '../ui/TeamSubmissionButtons'
...
export default function TeamSubmissions() {
  ...
  return (
    <div className="min-h-screen w-full space-y-4 bg-none">
      <div className="space-y-5 min-h-6 rounded-lg">
        <Hero
          title=""
          description=""
        />
      ...
      <div className="flex items-center justify-end rounded-lg bg-white p-4 shadow-sm">
        <div className="flex items-center justify-end w-full space-x-4 bg-[#F3F3F3] p-3 rounded-md">
          {/* Search Bar */}
          <div className="flex items-center h-10 w-64 rounded-md border border-[#D9D9D9] bg-white px-3">
            <input
              type="text"
              placeholder="Search"
      ...
      <div className="grid grid-cols-4 gap-4 bg-white p-4 rounded-lg shadow-sm">
        <div className="rounded-lg border border-[#99B7FF] bg-blue-50 p-4 text-left">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="0.25" y="0.25" width="39.5" height="39.5" rx="9.75" stroke="#D2D9DF" stroke-width="0.5" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20 29C24.9706 29 29 24.9706 29 20C29 15.0294 24.9706 11 20 11C15.0294 11 11 15.0294 11 20C11 24.9706 15.0294 29 20 29ZM20 16.5C20 15.9477 19.5523 15.5 19 15.5C18.4477 15.5 18 15.9477 18 16.5V21.5C18 22.0523 18.4477 22.5 19 22.5H22C22.5523 22.5 23 22.0523 23 21.5C23 20.9477 22.5523 20.5 22 20.5H20V16.5Z" fill="#3370FF" />
          </svg>
        ...
        <div className="rounded-lg border border-[#1FC16B] bg-green-50 p-4 text-left">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.25" y="0.25" width="39.5" height="39.5" rx="9.75" fill="white" />
            <rect x="0.25" y="0.25" width="39.5" height="39.5" rx="9.75" stroke="#D2D9DF" stroke-width="0.5" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20 29C24.9706 29 29 24.9706 29 20C29 15.0294 24.9706 11 20 11C15.0294 11 11 15.0294 11 20C11 24.9706 15.0294 29 20 29ZM23.6754 18.7375C24.0827 18.3644 24.1105 17.7319 23.7375 17.3246C23.3644 16.9173 22.7319 16.8895 22.3246 17.2625L18.6325 20.644L17.6754 19.7674C17.2681 19.3944 16.6356 19.4221 16.2626 19.8294C15.8895 20.2367 15.9173 20.8693 16.3246 21.2423L17.9571 22.7374C18.3393 23.0875 18.9257 23.0875 19.3079 22.7374L23.6754 18.7375Z" fill="#1FC16B" />
          </svg>
        ...
        <div className="rounded-lg border border-[#D00416] bg-red-50 p-4 text-left">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.25" y="0.25" width="39.5" height="39.5" rx="9.75" fill="white" />
            <rect x="0.25" y="0.25" width="39.5" height="39.5" rx="9.75" stroke="#D2D9DF" stroke-width="0.5" />
            <path fill-rule="evenodd" clip-rule="evenodd" d="M20 29C24.9706 29 29 24.9706 29 20C29 15.0294 24.9706 11 20 11C15.0294 11 11 15.0294 11 20C11 24.9706 15.0294 29 20 29ZM23.6754 18.7375C24.0827 18.3644 24.1105 17.7319 23.7375 17.3246C23.3644 16.9173 22.7319 16.8895 22.3246 17.2625L18.6325 20.644L17.6754 19.7674C17.2681 19.3944 16.6356 19.4221 16.2626 19.8294C15.8895 20.2367 15.9173 20.8693 16.3246 21.2423L17.9571 22.7374C18.3393 23.0875 18.9257 23.0875 19.3079 22.7374L23.6754 18.7375Z" fill="#D00416" />
          </svg>
        ...
        <div className="rounded-lg bg-[#F9F9F9] p-6 shadow-sm">
          ...
          <div className="mb-4 rounded-lg border-l-4 border-blue-500 bg-white p-4">
            ...
            <div className="mt-3 flex space-x-2">
              <ReviewDetailsButton onClick={() => navigate('/reviewDetails')} />
          ...
          {/* CARD 2 */}
          <div className="mb-4 rounded-lg border-l-4 border-green-500 bg-white p-4">
            <div className="flex items-center justify-between">
              <p className="font-semibold text-gray-800">David</p>
              <span className="rounded border border-green-300 bg-[#1FC16B1A] px-3 py-1 text-xs font-medium text-green-700">
                Approved
              </span>
            </div>
            <div className="mt-2 space-y-1 text-sm text-gray-600">
          ...
          <div className="rounded-lg border-l-4 border-red-500 bg-white p-4">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded border border-red-300 bg-[#FB37481A] px-3 py-1 text-xs font-medium text-red-700">
                Rejected
              </span>
            </div>
            <div className="mt-2 space-y-1 text-sm text-gray-600">
