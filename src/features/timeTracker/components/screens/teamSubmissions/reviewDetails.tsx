  ...
  return (
    <div className="min-h-screen w-full space-y-3 bg-none">
      ...
      <div className="flex items-center justify-between rounded-lg bg-white p-4 shadow-sm">
        ...
        <div className="flex flex-col">
          <div className="flex items-center space-x-2">
            <ArrowLeft className="h-5 w-5 cursor-pointer text-gray-700" onClick={() => navigate('/teamSubmissions')} />
      ...
      <div className="rounded-lg bg-white p-6">
        ...
        {/* Footer */}
        <div className="flex items-center justify-left gap-3 rounded-b-lg bg-white px-6 py-4 text-sm">
