...
export default function ViewUserPage() {
    ...
    return (
        <div className="min-h-screen w-full bg-none p-1 space-y-8">
            {/* Header */}
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm space-y-4">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-16 h-16 flex items-center justify-center bg-blue-600 text-white font-bold text-lg rounded-md">
                        BB
                        </div>
                        <div>
                    ...
                    >
                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.4967 0.841618C14.3746 -0.280539 12.5552 -0.28054 11.433 0.841618L4.32846 7.94617C3.81848 8.45616 3.48765 9.1178 3.38566 9.83179L3.17978 11.2729C3.02264 12.3729 3.96545 13.3157 5.0654 13.1585L6.50654 12.9527C7.22052 12.8507 7.88216 12.5199 8.39215 12.0099L15.4967 4.90531C16.6189 3.78315 16.6189 1.96377 15.4967 0.841618ZM12.7861 1.87539C13.2558 1.55516 13.9015 1.60341 14.3182 2.02013C14.7349 2.43685 14.7832 3.0825 14.4629 3.55223L12.7861 1.87539ZM11.5927 3.03899L13.2993 4.74565L7.21364 10.8314C6.95865 11.0863 6.62783 11.2518 6.27083 11.3028L4.82969 11.5086L5.03557 10.0675C5.08657 9.7105 5.25198 9.37968 5.50698 9.12468L11.5927 3.03899Z" fill="white"/>
                            <path d="M3.33333 0.0832954C1.49239 0.0832954 0 1.57568 0 3.41663V13.4166C0 15.2576 1.49238 16.75 3.33333 16.75H13.3333C15.1743 16.75 16.6667 15.2576 16.6667 13.4166V8.41663C16.6667 7.95639 16.2936 7.5833 15.8333 7.5833C15.3731 7.5833 15 7.95639 15 8.41663V13.4166C15 14.3371 14.2538 15.0833 13.3333 15.0833H3.33333C2.41286 15.0833 1.66667 14.3371 1.66667 13.4166V3.41663C1.66667 2.49615 2.41286 1.74996 3.33333 1.74996H5.57018C6.03041 1.74996 6.40351 1.37687 6.40351 0.916629C6.40351 0.456391 6.03041 0.0832954 5.57018 0.0832954H3.33333Z" fill="white"/>
                        </svg>
                        Edit User
                    </button>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                    <h3 className="text-md font-semibold text-gray-800 mb-3 flex items-center gap-2">
                        <img src="/icon/clock.svg" alt="Icon" className="text-gray-500"/> Activity Summary
                    </h3>
                    ...
                    <div className="space-y-2 text-sm text-gray-700 mt-4">
                        ...
                        <div className="flex justify-between items-center">
                            <p className="text-gray-500 text-xs">Average Daily:</p>
