...
const BillableChart:FC<ChartProps> = ({data,  colors = ['#F54E00', '#FFD400', '#00C628'],}) => {
  return (
     <div>
    ...
    <div className="relative w-full h-52"> {/* parent relative */}
  ...
  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
    <p className="text-[24px] font-semibold text-[#464E5F]">{data[0].value} %</p>
