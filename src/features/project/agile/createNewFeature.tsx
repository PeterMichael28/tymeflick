      ...
      <div className="mt-4 flex flex-col gap-3 rounded-lg bg-white p-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-2 rounded-lg border border-[#0B54FF] bg-[#CCDBFF4D] px-4 py-2">
              <p className="size-4 rounded bg-[#0B54FF]"></p>
              <p className="text-xs text-[#0B54FF]">Feature</p>
            </div>
            <p className="font-bricolage text-lg font-bold">
              Create New Feature
            </p>
          </div>
          <p className="font-bricolage text-sm font-normal text-[#4F5E6E]">
            Connected to: Epic 1 - E-commerce Platform Enhancement (You can
            change the epic its linked to in the options below)
          </p>
        </div>
