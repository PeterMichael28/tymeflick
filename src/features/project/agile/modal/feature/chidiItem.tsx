...
const ChildItem = () => {
  ...
  const handleCloseModal = () => dispatch(closeEditFeatureModal())
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="mt-1 flex items-center justify-between gap-3 rounded-lg border border-[#D2D9DF] bg-[#FAF9FB] p-4">
        <div className="flex items-center gap-2">
          <span className="flex items-center gap-2 rounded-lg border border-[#1FC16B] bg-[#1FC16B1A] px-3 py-2">
            <p className="size-4 rounded-md bg-[#1FC16B]"></p>
            <p className="font-bricolage text-sm text-[#1FC16B]">Story</p>
          </span>
