   ...
   return (
     <div>
      ...
      <div className="mt-4 flex flex-col gap-3 rounded-lg bg-white p-4">
                ...
                <div className="border-[#FF8800] flex items-center gap-2 rounded-lg border bg-[#FFDB431A] px-4 py-2">
                    <p className="bg-[#FF8800] size-4 rounded"></p>
                    <p className="text-[#FF8800] text-xs">Task</p>
                </div>
                <p className="font-bricolage text-lg font-bold">Create Task</p>
                </div>
                <p className='text-[#4F5E6E] text-sm font-bricolage font-normal'>Connected to: User Story #1 - Browse products on mobile device</p>
                </div>
