    ...
    <div className='bg-[#F9F9F9] p-5 rounded-3xl flex flex-col gap-4'>
      ...
      <div className='flex justify-between'>
        <div className='flex items-center gap-2'>
          <span className='font-bold font-bricolage text-[16px]'>Project Epic (Epic 1)</span>
           <img src="/icon/Group (7).svg" alt="Icon" />
          <p className='font-normal text-[#2B323B] text-[14px]'>Features</p>
          <img src="/icon/Group (7).svg" alt="Icon" />
          <p className='font-normal text-[#2B323B] text-[14px]'>Stories</p>
        </div>
      ...
      {stories.map((story, index) => (
        <div key={story.id} className='bg-white p-3 rounded-lg mb-4'>
          <div className='bg-[#F5F0FA] p-4 border border-primary rounded-lg'>
            ...
            <div className='flex flex-col gap-2'>
                <label className='text-grey900 text-[14px] font-inter font-normal'>Acceptance Criteria</label>
                <textarea
      ...
      <div className='flex justify-between mt-7'>
        <button
          className='flex gap-3 items-center text-[#1E1E1E] font-inter font-normal text-xs cursor-pointer'
          onClick={onPrev}
        >
          <ArrowLeft size={15} />
          Previous
